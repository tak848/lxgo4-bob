...
type preloadCounts struct {
	Member    memberCountPreloader
	Project   projectCountPreloader
	Task      taskCountPreloader
	Workspace workspaceCountPreloader
}

func getPreloadCount() preloadCounts {
	return preloadCounts{
		Member:    buildMemberCountPreloader(),
		Project:   buildProjectCountPreloader(),
		Task:      buildTaskCountPreloader(),
		Workspace: buildWorkspaceCountPreloader(),
	}
}

type thenLoadCounts[Q orm.Loadable] struct {
	Member    memberCountThenLoader[Q]
	Project   projectCountThenLoader[Q]
	Task      taskCountThenLoader[Q]
	Workspace workspaceCountThenLoader[Q]
}

func getThenLoadCount[Q orm.Loadable]() thenLoadCounts[Q] {
	return thenLoadCounts[Q]{
		Member:    buildMemberCountThenLoader[Q](),
		Project:   buildProjectCountThenLoader[Q](),
		Task:      buildTaskCountThenLoader[Q](),
		Workspace: buildWorkspaceCountThenLoader[Q](),
	}
}
